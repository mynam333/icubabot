...
token = "NTMwMzIxNjY0ODI3NzE5Njgw.DxGg4g.Ft4GrxK9EjJ2RNNwX5khGG6U8vg"
...
async def on_message(message):
    ...
    elif message.content.startswith('!나이'): #만약 해당 메시지가 '!커맨드' 로 시작하는 경우에는
        await client.send_message(channel, '아무튼 늙었습니다. 와 늙쿠!') #봇은 해당 채널에 '커맨드' 라고 말합니다.

    elif message.content.startswith('!키'): #만약 해당 메시지가 '!커맨드' 로 시작하는 경우에는
